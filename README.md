...
<div class="content">
  ...
  <div id="poems" class="tab">
    ...
    <div class="poem">
Слова ложатся тихо на бумагу,
Как снег — без шума, без следа.
Я в каждой строчке оставляю
То, что не скажут города.
    </div>

    <hr>

    <div class="poem">
Ночь умеет слушать лучше,
Чем дневной пустой ответ.
Я писал — и становился
Чуть честнее, чем поэт.
    </div>
  </div>
  ...
  <div id="works" class="tab">
    ...
    <p>
      Небольшое философское произведение  
      о тишине, выборе и внутреннем диалоге человека.
    </p>
  </div>
